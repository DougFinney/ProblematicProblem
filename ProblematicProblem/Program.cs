    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (cont)
            {
                ...
                Console.Write($"What is your age, {userName}?");
                int userAge = Convert.ToInt32(Console.ReadLine());
                Console.WriteLine("Awesome!");
                Console.Write($"Would you like to see the current list of activities {userName}? Sure/No thanks: ");
                ...
                if (seeList)
                {
                    ...
                    Console.WriteLine();
                    Console.Write($"{userName} Would you like to add any activities before we generate one? yes/no: ");
